...
export default function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        // Store token in localStorage (consistent naming)
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <div className="mt-1 relative">
            <input
              ...
              onChange={handleChange}
              className="appearance-none relative block w-full px-3 py-2 pr-10 border border-gray-300 dark:border-gray-600 placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-white bg-white dark:bg-gray-800 rounded-md focus:outline-none focus:ring-gray-500 focus:border-gray-500 focus:z-10 sm:text-sm"
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-sm">
            <a href="/forgot-password" className="font-medium text-gray-900 dark:text-white hover:underline">
